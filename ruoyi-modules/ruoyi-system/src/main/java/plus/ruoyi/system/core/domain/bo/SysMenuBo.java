...
import plus.ruoyi.common.json.validate.JsonPattern;
import plus.ruoyi.common.json.validate.JsonType;
...
public class SysMenuBo extends BaseEntity {
    ...
    @Pattern(regexp = RegexPatterns.PERMISSION, message = "权限标识必须符合 tool:build:query 格式")
