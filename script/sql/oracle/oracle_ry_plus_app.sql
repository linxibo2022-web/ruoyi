...
create table b_ad (
                      ...
                      ad_unit_id   varchar2(100)   default null,
                      ...
                      jump_appid   varchar2(50)    default null,
                      jump_path    varchar2(255)   default null,
                      style_config varchar2(255)   default null,
                      sort_order   number(4)       default 999,
...
-- 创建序列
create sequence seq_b_ad start with 1 increment by 1;

alter table b_ad add constraint pk_b_ad primary key (id);
...
create table b_bind (
                        ...
                        platform_type varchar2(20)    default null,
                        appid         varchar2(30)    default null,
                        unionid       varchar2(30)    default null,
                        openid        varchar2(30)    default null,
                        extra_data    varchar2(255)   default null,
                        create_dept   number(20)      default null,
                        create_by     number(20)      default null,
...
alter table b_bind add constraint pk_b_bind primary key (id);
...
create table b_payment (
                           ...
                           mch_name           varchar2(30)     default null,
                           mch_id             varchar2(20)     default null,
                           mch_key            varchar2(50)     default null,
                           api_v3_key         varchar2(50)     default null,
                           cert_path          varchar2(2000)   default null,
                           key_path           varchar2(2000)   default null,
                           platform_cert_path varchar2(2000)   default null,
                           cert_serial_no     varchar2(100)    default null,
                           public_key_id      varchar2(100)    default null,
                           p12_cert_path      varchar2(500)    default null,
                           status             char(1)          default '1',
                           create_dept        number(20)       default null,
                           create_by          number(20)       default null,
                           create_time        date             default null,
...
alter table b_payment add constraint pk_b_payment primary key (id);
...
create table b_platform (
                            ...
                            appid            varchar2(30)    default null,
                            secret           varchar2(50)    default null,
                            token            varchar2(50)    default null,
                            aeskey           varchar2(50)    default null,
                            payment_ids      varchar2(100)   default null,
                            template_configs varchar2(2000)  default null,
                            status           char(1)         default '1',
                            create_dept      number(20)      default null,
                            create_by        number(20)      default null,
                            create_time      date            default null,
...
alter table b_platform add constraint pk_b_platform primary key (id);
...
create table m_goods (
                         ...
                         imgs          varchar2(1000)  default null,
                         spec_type     char(1)         default '0',
                         original_price number(10,2)   default null,
                         discount      number(3,2)     default 1.00,
                         price         number(10,2)    default null,
                         description   clob            default null,
                         stock         number(11)      default null,
                         sales_count   number(11)      default 0,
                         status        char(1)         default '1',
                         sort_order    number(4)       default 999,
                         create_dept   number(20)      default null,
                         create_by     number(20)      default null,
...
-- 创建序列
create sequence seq_m_goods start with 1 increment by 1;

alter table m_goods add constraint pk_m_goods primary key (id);
...
create table m_goods_sku (
                             ...
                             sku_code       varchar2(50)    default null,
                             sku_name       varchar2(200)   default null,
                             spec_values    varchar2(500)   not null,
                             original_price number(10,2)    default null,
...
-- 创建序列
create sequence seq_m_goods_sku start with 1 increment by 1;

alter table m_goods_sku add constraint pk_m_goods_sku primary key (id);
alter table m_goods_sku add constraint uk_m_goods_sku_code unique (sku_code);
...
create table m_order (
                         ...
                         user_id        number(20)      default null,
                         goods_id       number(20)      not null,
                         sku_id         number(20)      default null,
                         goods_name     varchar2(200)   default null,
                         sku_name       varchar2(200)   default null,
                         spec_values    varchar2(500)   default null,
                         goods_img      varchar2(255)   default null,
                         price          number(10,2)    not null,
                         quantity       number(4)       not null,
                         total_amount   number(10,2)    not null,
                         actual_amount  number(10,2)    default null,
                         order_status   varchar2(20)    default 'pending',
                         payment_method varchar2(20)    default null,
                         payment_time   date            default null,
                         transaction_id varchar2(64)    default null,
                         buyer_remark   varchar2(500)   default null,
                         order_ext_info varchar2(500)   default null,
                         receiver_info  varchar2(500)   default null,
                         shipping_info  varchar2(1000)   default null,
                         create_dept    number(20)      default null,
                         create_by      number(20)      default null,
                         create_time    date            default sysdate,
                         update_by      number(20)      default null,
...
-- 创建序列
create sequence seq_m_order start with 1 increment by 1;

alter table m_order add constraint pk_m_order primary key (id);
alter table m_order add constraint uk_m_order_no unique (order_no);
...
insert into sys_menu values('2000', 'APP配置', '0', '95', 'appConfiguration', null, null, '0', '1', 'M', '1', '1', null, 'app', 103, 1, sysdate, 1, sysdate, 'APP配置目录');

-- 商城管理主菜单
-- noinspection SqlResolve
insert into sys_menu values('2001', '商城管理', '0', '90', 'mallManage', null, null, '0', '1', 'M', '1', '1', null, 'store', 103, 1, sysdate, 1, sysdate, '商城管理目录');

-- 平台配置菜单
-- noinspection SqlResolve
insert into sys_menu values('2010', '平台配置', '2000', '10', 'platform', 'business/base/platform/platform', null, '0', '1', 'C', '1', '1', 'base:platform:view', 'slider', 103, 1, sysdate, null, null, '平台配置菜单');
-- noinspection SqlResolve
insert into sys_menu values('2011', '平台配置查询', '2010', '1', '#', '', null, '0', '1', 'F', '1', '1', 'base:platform:query', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2012', '平台配置新增', '2010', '2', '#', '', null, '0', '1', 'F', '1', '1', 'base:platform:add', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2013', '平台配置修改', '2010', '3', '#', '', null, '0', '1', 'F', '1', '1', 'base:platform:update', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2014', '平台配置删除', '2010', '4', '#', '', null, '0', '1', 'F', '1', '1', 'base:platform:delete', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2015', '平台配置导出', '2010', '5', '#', '', null, '0', '1', 'F', '1', '1', 'base:platform:export', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2016', '平台配置导入', '2010', '6', '#', '', null, '0', '1', 'F', '1', '1', 'base:platform:import', '#', 103, 1, sysdate, null, null, '');

-- 支付配置菜单
-- noinspection SqlResolve
insert into sys_menu values('2020', '支付配置', '2000', '20', 'payment', 'business/base/payment/payment', null, '0', '1', 'C', '1', '1', 'base:payment:view', 'payment', 103, 1, sysdate, null, null, '支付配置菜单');
-- noinspection SqlResolve
insert into sys_menu values('2021', '支付配置查询', '2020', '1', '#', '', null, '0', '1', 'F', '1', '1', 'base:payment:query', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2022', '支付配置新增', '2020', '2', '#', '', null, '0', '1', 'F', '1', '1', 'base:payment:add', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2023', '支付配置修改', '2020', '3', '#', '', null, '0', '1', 'F', '1', '1', 'base:payment:update', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2024', '支付配置删除', '2020', '4', '#', '', null, '0', '1', 'F', '1', '1', 'base:payment:delete', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2025', '支付配置导出', '2020', '5', '#', '', null, '0', '1', 'F', '1', '1', 'base:payment:export', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2026', '支付配置导入', '2020', '6', '#', '', null, '0', '1', 'F', '1', '1', 'base:payment:import', '#', 103, 1, sysdate, null, null, '');

-- 账号绑定菜单
-- noinspection SqlResolve
insert into sys_menu values('2030', '账号绑定', '2000', '1', 'bind', 'business/base/bind/bind', null, '0', '1', 'C', '1', '1', 'base:bind:view', 'link', 103, 1, sysdate, null, null, '账号绑定菜单');
-- noinspection SqlResolve
insert into sys_menu values('2031', '账号绑定查询', '2030', '1', '#', '', null, '0', '1', 'F', '1', '1', 'base:bind:query', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2032', '账号绑定新增', '2030', '2', '#', '', null, '0', '1', 'F', '1', '1', 'base:bind:add', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2033', '账号绑定修改', '2030', '3', '#', '', null, '0', '1', 'F', '1', '1', 'base:bind:update', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2034', '账号绑定删除', '2030', '4', '#', '', null, '0', '1', 'F', '1', '1', 'base:bind:delete', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2035', '账号绑定导出', '2030', '5', '#', '', null, '0', '1', 'F', '1', '1', 'base:bind:export', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2036', '账号绑定导入', '2030', '6', '#', '', null, '0', '1', 'F', '1', '1', 'base:bind:import', '#', 103, 1, sysdate, null, null, '');

-- 广告配置菜单
-- noinspection SqlResolve
insert into sys_menu values('2040', '广告配置', '2000', '30', 'ad', 'business/base/ad/ad', null, '0', '1', 'C', '1', '1', 'base:ad:view', 'wishlist', 103, 1, sysdate, null, null, '广告配置菜单');
-- noinspection SqlResolve
insert into sys_menu values('2041', '广告配置查询', '2040', '1', '#', '', null, '0', '1', 'F', '1', '1', 'base:ad:query', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2042', '广告配置新增', '2040', '2', '#', '', null, '0', '1', 'F', '1', '1', 'base:ad:add', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2043', '广告配置修改', '2040', '3', '#', '', null, '0', '1', 'F', '1', '1', 'base:ad:update', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2044', '广告配置删除', '2040', '4', '#', '', null, '0', '1', 'F', '1', '1', 'base:ad:delete', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2045', '广告配置导出', '2040', '5', '#', '', null, '0', '1', 'F', '1', '1', 'base:ad:export', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2046', '广告配置导入', '2040', '6', '#', '', null, '0', '1', 'F', '1', '1', 'base:ad:import', '#', 103, 1, sysdate, null, null, '');

-- 商品菜单
-- noinspection SqlResolve
insert into sys_menu values('2110', '商品', '2001', '1', 'goods', 'business/mall/goods/goods', null, '0', '1', 'C', '1', '1', 'mall:goods:view', 'bag', 103, 1, sysdate, null, null, '商品菜单');
-- noinspection SqlResolve
insert into sys_menu values('2111', '商品查询', '2110', '1', '#', '', null, '0', '1', 'F', '1', '1', 'mall:goods:query', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2112', '商品新增', '2110', '2', '#', '', null, '0', '1', 'F', '1', '1', 'mall:goods:add', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2113', '商品修改', '2110', '3', '#', '', null, '0', '1', 'F', '1', '1', 'mall:goods:update', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2114', '商品删除', '2110', '4', '#', '', null, '0', '1', 'F', '1', '1', 'mall:goods:delete', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2115', '商品导出', '2110', '5', '#', '', null, '0', '1', 'F', '1', '1', 'mall:goods:export', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2116', '商品导入', '2110', '6', '#', '', null, '0', '1', 'F', '1', '1', 'mall:goods:import', '#', 103, 1, sysdate, null, null, '');

-- 订单菜单
-- noinspection SqlResolve
insert into sys_menu values('2120', '订单', '2001', '10', 'order', 'business/mall/order/order', null, '0', '1', 'C', '1', '1', 'mall:order:view', 'order', 103, 1, sysdate, null, null, '订单菜单');
-- noinspection SqlResolve
insert into sys_menu values('2121', '订单查询', '2120', '1', '#', '', null, '0', '1', 'F', '1', '1', 'mall:order:query', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2122', '订单新增', '2120', '2', '#', '', null, '0', '1', 'F', '1', '1', 'mall:order:add', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2123', '订单修改', '2120', '3', '#', '', null, '0', '1', 'F', '1', '1', 'mall:order:update', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2124', '订单删除', '2120', '4', '#', '', null, '0', '1', 'F', '1', '1', 'mall:order:delete', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2125', '订单导出', '2120', '5', '#', '', null, '0', '1', 'F', '1', '1', 'mall:order:export', '#', 103, 1, sysdate, null, null, '');
-- noinspection SqlResolve
insert into sys_menu values('2126', '订单导入', '2120', '6', '#', '', null, '0', '1', 'F', '1', '1', 'mall:order:import', '#', 103, 1, sysdate, null, null, '');
